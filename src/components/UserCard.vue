<template>
  <div class="col-3">
    <router-link to="#">
      <img :src="userImage" width="auto" height="140px" />
    </router-link>
    <h2>{{ user.name }}</h2>
    ...
    <p class="mt-3">
      ...
      >取消追蹤</button>
      <button v-else @click.prevent.stop="follow" type="button" class="btn btn-primary">追蹤</button>
    </p>
  </div>
</template>
